...
<div class="container">
	...
	<div class="row">
			...
			if ( is_active_sidebar( 'sidebar-ourfocus' ) ) :
				...
				the_widget( 'zerif_ourfocus','title=Silver &text=Dust and Vacuum Every Room, Mop All Floors, Completely Sanitize Kitchen and Bathrooms, Make All Beds, Clean All Windowsills&link=#&image_uri='.get_stylesheet_directory_uri()."/images/number.png" );

				the_widget( 'zerif_ourfocus','title=Gold &text=Everything in SILVER, Plus Clean All Cabinets, Light Fixtures, Switch Plates, Outlet Covers, Ceiling Fans, Doors, and Door Trim&link=#&image_uri='.get_stylesheet_directory_uri()."/images/number_2.png" );

				the_widget( 'zerif_ourfocus','title=Platinum &text=Everything in GOLD, Plus Clean All Carpets, Windows, Baseboards, and Appliances&link=#&image_uri='.get_stylesheet_directory_uri()."/images/number_3.png" );
